...
Usage:
    python scripts/data_management/filter_sessions.py --manifest pdf_output/all_sessions_manifest.csv --out-dir pdf_output/filtered
"""
import argparse
import pandas as pd
import yaml
...
def apply_filters(df, rules):
    ...
    for rule in rules:
        ...
        try:
            ...
            # Don't exit, just skip rule? Or exit?
            # sys.exit(1) 
